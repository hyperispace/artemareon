...
const Welcome = () => {
  ...
  return !isEntered ? (
    <section className='fixed w-full h-full flex flex-col gap-32 justify-start items-center text-white bg-[url("/assets/welcome.webp")] bg-no-repeat bg-cover bg-center pt-28 text-center z-10'>
